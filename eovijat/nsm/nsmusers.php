                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-12 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="role form-control" name="role" value="nsm" value="<?php if (isset($_POST['submit'])) {
                                    echo $role;
                                } ?>" required readonly>
...
$sql = "SELECT id, email, status, role FROM users where role='nsm' ORDER BY id DESC";
$result = mysqli_query($conn, $sql);
