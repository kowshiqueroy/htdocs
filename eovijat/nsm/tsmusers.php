                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 col-12 ">
                            <div class="form-group">
                                ...
                                <input type="text" class="role form-control" name="role" value="tsm" value="<?php if (isset($_POST['submit'])) {
                                    echo $role;
                                } ?>" required readonly>
...
<?php
    $sql = "SELECT email FROM users where role='rsm' ORDER BY id DESC";
    $result = mysqli_query($conn, $sql);
...
$sql = "SELECT id, email, status, role, parent FROM users where role='tsm' ORDER BY parent DESC";
$result = mysqli_query($conn, $sql);
