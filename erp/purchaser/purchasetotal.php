...
<?php
    ...
    $sql = "SELECT DISTINCT item FROM requisitionlist WHERE (status= '5' OR status= '4')  AND purchaser='$user'
...
if(isset($_REQUEST['searchi'])){
    ...
    if (strcmp($si,"All" )  ) {
        ...
        $sql = "SELECT * FROM requisitionlist WHERE (status= '5' OR status= '4')  AND (item like '%$si%') purchaser='$user' ORDER BY id DESC ";
    }


    else  {

        $sql = "SELECT * FROM requisitionlist WHERE (status= '5' OR status= '4') purchaser='$user' ORDER BY id DESC ";
    }
            ...
            <div style="overflow-x:auto;">
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $sql2 = "SELECT item, pqty,fqty FROM requisitionlist WHERE (status= '5' OR status= '4') AND purchaser='$user' AND item='$item'";
