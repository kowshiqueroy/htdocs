...
class IndianCurrency{
  ...
  public function get_words(){
    $w="";
    $crore=(int)($this->takas/10000000);
    $this->takas=$this->takas%10000000;
    $w.=$this->single_word($crore,"Cror ");
    $lakh=(int)($this->takas/100000);
    $this->takas=$this->takas%100000;
    $w.=$this->single_word($lakh,"Lakh ");
    $thousand=(int)($this->takas/1000);
    $this->takas=$this->takas%1000;
    $w.=$this->single_word($thousand,"Thousand  ");
    $hundred=(int)($this->takas/100);
